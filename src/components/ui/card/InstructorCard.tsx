  ...
  return (
    <div className="relative min-w-[147px] overflow-hidden lg:rounded-[18px]">
      <Image
        src={instructor}
        alt="instructor"
        className="z-10 h-[269px] min-w-[147px] rounded-[3px] object-cover before:absolute before:z-20 before:h-full before:w-full before:bg-expertGradient lg:h-[400px] lg:w-[285px] lg:rounded-none"
      />
