...
export default function InstructorCard() {
  return (
    <div className="relative overflow-hidden before:z-20 before:h-full before:w-full before:bg-expertGradient lg:rounded-[18px] lg:before:absolute">
      <Image
        src={instructor}
        alt="instructor"
        className="z-10 h-[269px] w-[147px] rounded-[3px] object-cover lg:h-[400px] lg:w-[285px] lg:rounded-none"
      />
